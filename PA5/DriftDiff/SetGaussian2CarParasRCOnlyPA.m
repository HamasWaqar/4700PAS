...
% NetDoping = ones(1,nx).*Nd; % doping for constant

% ----- Linear Net Doping
% DoppingNDLinear = linspace(1e16,20e16,nx);
% Nd = DoppingNDLinear .* 1e6; % Const. 1/cm3 (100 cm/m)^3
% NetDoping = ones(1,nx).*Nd; % doping for constant

% ----- Exponential Net Doping
DoppingNDLinear = logspace(log10(1e16),log10(20e16),nx);
Nd = DoppingNDLinear .* 1e6; % Const. 1/cm3 (100 cm/m)^3
NetDoping = ones(1,nx).*Nd; % doping for constant
